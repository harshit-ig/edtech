...
import { CheckCircle, Phone, Mail, ArrowRight, Clock, Target, Users, Award, Star, BarChart, TrendingUp, Brain, Database, Menu, X } from 'lucide-react';
...
export default function ThankYouPage() {
  ...
  useEffect(() => {
    // Set page title
    document.title = 'Application Submitted - Data Analytics Career Program | Edtech Informative';
      ...
      <section className="pt-28 relative bg-gradient-to-br from-blue-50 via-purple-50 to-gray-50 text-gray-900 min-h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="absolute inset-0 overflow-hidden opacity-20 hidden md:block">
            ...
            <div className="absolute top-32 right-20 space-y-4">
              <div className="animate-float">
                <BarChart className="w-8 h-8 text-blue-500 opacity-60" />
              </div>
              <div className="animate-float" style={{animationDelay: '1s'}}>
                <TrendingUp className="w-8 h-8 text-purple-500 opacity-60" />
              </div>
              <div className="animate-float" style={{animationDelay: '2s'}}>
                <Database className="w-8 h-8 text-green-500 opacity-60" />
              </div>
            </div>
            ...
            <div className="absolute bottom-32 left-32 space-x-4 flex">
              <div className="animate-bounce" style={{animationDelay: '0.5s'}}>
                <Brain className="w-6 h-6 text-indigo-500 opacity-40" />
              </div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-sm opacity-90">95% job placement rate with starting salaries of £30K-£55K</p>
              </div>
              <div className="text-center">
                <div className="bg-white/20 p-4 rounded-lg mb-4 inline-block">
                ...
                <p className="text-sm opacity-90">Learn from working data scientists at top companies</p>
              </div>
              <div className="text-center">
                <div className="bg-white/20 p-4 rounded-lg mb-4 inline-block">
                ...
                <p className="text-sm opacity-90">Build a portfolio with 5+ data analytics projects</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="mt-1">Reference: DA-{Date.now().toString().slice(-6)}</p>
          </motion.div>
        </div>
      </section>
