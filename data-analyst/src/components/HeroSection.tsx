          ...
          >
            <div className="relative bg-white rounded-3xl shadow-2xl p-8 float">
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <Image
                      ...
                      loading="lazy"
                    />
                    <span className="text-gray-400 text-xs font-mono">Data Studio</span>
                  </div>
                </div>
                <div className="space-y-2 text-sm font-mono">
                  <div className="flex">
                    <span className="text-blue-400">import</span>
                    <span className="text-white ml-2">pandas</span>
                    <span className="text-white ml-2">as</span>
                    <span className="text-yellow-300 ml-2">pd</span>
                  </div>
                  <div className="text-white">
                    <span className="text-blue-400">import</span>
                    <span className="text-white ml-2">matplotlib.pyplot</span>
                    <span className="text-white ml-2">as</span>
                    <span className="text-yellow-300 ml-2">plt</span>
                  </div>
                  <div className="text-white mt-2">
                    <span className="text-gray-500"># Load and analyze data</span>
                  </div>
                  <div className="text-white">
                    <span className="text-cyan-400">df</span>
                    <span className="text-white ml-2">=</span>
                    <span className="text-yellow-300 ml-2">pd</span>
                    <span className="text-white">.</span>
                    <span className="text-green-400">read_csv</span>
                    <span className="text-white">(</span>
                    <span className="text-orange-400">'sales_data.csv'</span>
                    <span className="text-white">)</span>
                  </div>
                  <div className="text-white">
                    <span className="text-cyan-400">insights</span>
                    <span className="text-white ml-2">=</span>
                    <span className="text-yellow-300 ml-2">df</span>
                    <span className="text-white">.</span>
                  ...
                  <div className="text-gray-500 mt-2">
                    <span className="text-gray-500">// 📊 Ready to analyze data?</span>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {['Python', 'SQL', 'Excel', 'Tableau'].map((skill, index) => (
                  <motion.div
                    key={skill}
