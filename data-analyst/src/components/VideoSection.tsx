      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Watch how our 6-month comprehensive program helps professionals land high-paying data analyst jobs and build successful freelancing businesses. 
        ...
        >
          ...
          >
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100 text-center">
              ...
              <p className="text-gray-600 text-sm">See how professionals build 6-figure careers in 6 months</p>
            </div>
        ...
        >
          <p className="text-gray-600 text-lg mb-6">
            Ready to start your data analytics transformation journey?
          </p>
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
