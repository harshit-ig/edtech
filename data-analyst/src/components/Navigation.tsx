...
export default function Navigation({ onApplyNow }: NavigationProps) {
  ...
  return (
    <>
      {/* Urgency Top Bar */}
      <div className="fixed top-0 w-full z-50 bg-gradient-to-r from-red-600 to-orange-600 text-white py-2 text-center text-sm">
        <motion.div
        ...
        >
          <div className="flex items-center space-x-2">
            ...
            <span className="font-semibold">
              Early Bird Ends: {timeLeft.hours}h {timeLeft.minutes}m
            </span>
          </div>
      ...
      {/* Main Navigation */}
      <nav className="fixed top-8 w-full z-40 glass backdrop-blur-lg border-b border-white/10">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            >
              ...
              <div className="flex flex-col">
                <span className="text-lg font-bold text-foreground">Edtech Informative</span>
                <span className="text-xs text-primary font-medium">6-Month Data Analytics Career Program</span>
              </div>
            </motion.div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={onApplyNow}
                className="bg-gradient-to-r from-primary to-secondary text-white px-6 py-3 rounded-full font-bold hover:shadow-lg transition-all pulse-glow flex items-center space-x-2"
              >
