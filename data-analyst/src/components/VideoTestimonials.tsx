    ...
    <section className="py-16 bg-gradient-to-br from-purple-50 via-white to-blue-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-purple-50 via-white to-transparent pointer-events-none z-10"></div>
          <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-blue-50 via-white to-transparent pointer-events-none z-10"></div>
        </div>
      </div>
    </section>
  );
