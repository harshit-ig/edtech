...
export default function CurrentBatchTestimonials() {
  const currentBatchTestimonials = [
    {
      ...
      testimonial: "Just completed week 8! The SQL and Python modules are incredible. Already automated my daily reporting tasks and saving 3 hours daily.",
      batchWeek: "Week 8",
      progress: 75
    },
    {
    ...
    {
      name: "David Kumar",
      role: "Junior Data Analyst @ Tech",
      image: "https://randomuser.me/api/portraits/men/76.jpg",
      testimonial: "Week 6 update: Advanced Excel techniques have transformed my workflow. My manager is impressed with my new analytical capabilities.",
      batchWeek: "Week 6", 
      progress: 60
    },
    {
  ...
  const batchStats = [
    { label: "Active Learners", value: "52", icon: Users },
    { label: "Current Week", value: "Week 8", icon: Calendar },
    { label: "Avg Progress", value: "78%", icon: Star }
  ];
