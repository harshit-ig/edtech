        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-6 leading-tight">
              ...
              <span className="text-primary">Agentic AI Professional</span>
            ...
            <p className="text-lg text-gray-600 mb-8">
              ...
              industry-recognized certificate that validates your expertise in Agentic AI 
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-700">Verified completion of 100+ hours of comprehensive training</span>
              </div>
              <div className="flex items-center space-x-3">
                <CheckCircle className="w-5 h-5 text-success flex-shrink-0" />
                <span className="text-gray-700">Hands-on project portfolio with real AI agents</span>
              </div>
              <div className="flex items-center space-x-3">
                <CheckCircle className="w-5 h-5 text-success flex-shrink-0" />
                <span className="text-gray-700">Showcase your skills to top AI companies</span>
              </div>
              <div className="flex items-center space-x-3">
                <CheckCircle className="w-5 h-5 text-success flex-shrink-0" />
            ...
            <div className="relative bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-2xl p-8 border-4 border-primary/20">
              ...
              <div className="text-center mb-6">
                ...
                <div className="bg-primary/10 rounded-lg p-4 mb-4">
                  <h5 className="text-xl font-bold text-primary mb-2">
                    Agentic AI Professional Bootcamp
                  </h5>
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Demonstrating proficiency in AI agents, LangChain, AutoGen, and production deployment
                </p>
              </div>
              ...
              <div className="flex justify-between items-end text-xs text-gray-500">
                ...
                <div className="text-right">
                  ...
                  <p>Verification ID: #AI-CERT2025</p>
                </div>
              </div>
