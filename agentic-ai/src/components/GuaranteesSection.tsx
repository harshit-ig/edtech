...
export default function GuaranteesSection({ onApplyNow }: GuaranteesSectionProps) {
  const guarantees = [
    ...
    },
    {
      ...
      description: "Access to our exclusive network of 200+ hiring partners actively seeking AI talent.",
