...
import { Lock, Mail, AlertCircle, Eye, EyeOff, Laptop } from 'lucide-react';
        ...
        <div className="mx-auto w-full max-w-sm lg:w-96">
          <div>
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">EdTech Admin</h1>
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <div className="text-xs text-blue-700 space-y-1">
                  <p><strong>Email:</strong> admin@edtech.com</p>
          ...
          <div className="relative h-full flex flex-col justify-center items-center p-12 text-white">
            <div className="max-w-md text-center">
              ...
              <p className="text-xl text-blue-100 mb-8">
                Powerful admin dashboard to manage courses, users, content, and analytics
              </p>
